drop table idl_msg_template_score_tmp;
CREATE TABLE idl_msg_template_score_tmp
...
--初始化
ALTER TABLE idl_msg_template_score_tmp DROP PARTITION(ds <= "2017-06-22" );
INSERT INTO idl_msg_template_score_tmp PARTITION (ds="2017-06-22")
SELECT
t1.tmp_id,
t1.signature,
t1.dimension,
