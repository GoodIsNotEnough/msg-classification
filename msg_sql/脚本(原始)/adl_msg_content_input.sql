CREATE TABLE if not exists adl_msg_content_input
(
...
-- 初始化
ALTER TABLE adl_msg_content_input DROP PARTITION(ds='2017-06-22');
INSERT INTO adl_msg_content_input PARTITION (ds='2017-06-22')
SELECT 
md5(msg) AS msg_id,
msg      
FROM
